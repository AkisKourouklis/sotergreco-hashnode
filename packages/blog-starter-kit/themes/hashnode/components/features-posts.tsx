    ...
    <div className="blog-featured-area mx-auto border-b bg-slate-50 dark:border-slate-800 dark:bg-black">
      <div className="container mx-auto mt-8 px-4 xl:px-10 2xl:px-24">
        <div className="border border-gray-100 rounded-lg overflow-hidden">
          <Ads adLocation="home-top"/>
        </div>
      </div>
      <div
        className="blog-featured-container container mx-auto grid grid-cols-1 gap-8 px-4 py-4 md:grid-flow-col md:grid-cols-2 md:grid-rows-2 xl:grid-cols-3 xl:py-10 xl:px-10 2xl:px-24 2xl:py-10">
        {posts.map((post, index) => {
          ...
          return (
            ...
            >
              ...
              {isPinnedToBlog && (
                <div
                  className="blog-article-card-label mx-4 mb-1 flex flex-row items-center break-words font-heading font-medium leading-snug text-blue-600 dark:text-blue-500">
                  <span>Pinned</span>
              ...
              {isFirstPost && (
                <p
                  className="blog-article-card-brief mx-4 mb-3 break-words text-lg leading-snug text-slate-500 hover:opacity-75 dark:text-slate-400">
                  <Link href={postURL} onMouseOver={preload(post.slug)} onFocus={() => undefined}>
